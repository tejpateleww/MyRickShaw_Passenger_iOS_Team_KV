...
//            UtilityClass.showAlert("Missing", message: "Please Enter Company Name / Name", vc: self)
            UtilityClass.setCustomAlert(title: appName, message: "Please Enter Company Name / Name") { (index, title) in
            }
        }
...
//                UtilityClass.showAlert("", message: "Please enter valid CVV Number", vc: self)
                UtilityClass.setCustomAlert(title: appName, message: "Please enter valid CVV Number") { (index, title) in
                }
            }
        }
        else {
