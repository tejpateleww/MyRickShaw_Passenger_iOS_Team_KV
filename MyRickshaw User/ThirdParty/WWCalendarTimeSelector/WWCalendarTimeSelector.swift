...
internal class WWClock: UIView {
    ...
    internal override func draw(_ rect: CGRect) {
        ...
        if showingHour {
            ...
            let textAttr = [NSAttributedString.Key.font: fontHour, NSAttributedString.Key.foregroundColor: fontColorHour, NSAttributedString.Key.paragraphStyle: paragraph] as [NSObject : Any]
            let textAttrHighlight = [NSAttributedString.Key.font.rawValue: fontHourHighlight, NSAttributedString.Key.foregroundColor: fontColorHourHighlight, NSAttributedString.Key.paragraphStyle: paragraph] as [NSObject : Any]
            
            let templateSize = NSAttributedString(string: "12", attributes: textAttr as? [NSAttributedString.Key : Any]).size()
            let templateSizeHighlight = NSAttributedString(string: "12", attributes: textAttrHighlight as? [NSAttributedString.Key : Any]).size()
            ...
            for (index, element) in hours.enumerated() {
                ...
                if element == currentHour {
                    ...
                    // numbers
                    let hour = NSAttributedString(string: "\(element)", attributes: textAttrHighlight as! [NSAttributedString.Key : Any])
                    ctx?.saveGState()
                    ctx?.scaleBy(x: -1, y: 1)
                    ctx?.translateBy(x: radiusHighlight * cos(angle), y: -(radiusHighlight * sin(angle)))
                    ctx?.scaleBy(x: -1, y: 1)
                    ...
                    // numbers
                    let hour = NSAttributedString(string: "\(element)", attributes: textAttr as! [NSAttributedString.Key : Any])
                    ctx?.saveGState()
                    ctx?.scaleBy(x: -1, y: 1)
            ...
            let textAttr : [NSAttributedString.Key : Any] = [NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue): fontMinute, NSAttributedString.Key(rawValue: NSAttributedString.Key.foregroundColor.rawValue): fontColorMinute, NSAttributedString.Key.paragraphStyle: paragraph]
            let textAttrHighlight : [NSAttributedString.Key : Any] = [NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue): fontMinuteHighlight, NSAttributedString.Key(rawValue: NSAttributedString.Key.foregroundColor.rawValue): fontColorMinuteHighlight, NSAttributedString.Key.paragraphStyle: paragraph]
