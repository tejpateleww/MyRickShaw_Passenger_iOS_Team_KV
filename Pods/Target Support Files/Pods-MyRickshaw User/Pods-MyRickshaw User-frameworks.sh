...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CreditCardForm/CreditCardForm.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DOAlertController/DOAlertController.framework"
